package com.shineyue.autogenerator;
...
/**
 * @PackageName: com.shineyue.autogenerator
 * @Description:
 * @author: 罗秉荣
 * @date: 2020/10/13
 */
public class AutoGenerator {
    public static void main(String[] args) {
        //代码自动生成器 对象
        com.baomidou.mybatisplus.generator.AutoGenerator auto = new com.baomidou.mybatisplus.generator.AutoGenerator();
